...
The v3 API also exposes an additive feature to turn a published blog article
into a short narrated MP4 (stock footage + voice) via VideoGen — see
[`bakerydemo/videos/README.md`](bakerydemo/videos/README.md).
