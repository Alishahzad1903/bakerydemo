...
- Use the **api** skill — VideoGen's own skill for its API, available to you in this workspace
...
- If that skill does not cover a capability you need, **STOP and report the gap** — do not
